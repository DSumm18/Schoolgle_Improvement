...
export async function POST(request: NextRequest) {
  try {
    ...
    // Debug: Log if screenshot was received
    console.log("[Ed Chat API] Request - image:", !!image, image ? `(${image.length} chars, starts with data:image/jpeg: ${image.startsWith("data:image/jpeg")})` : "none");
    ...
    console.log("[Ed Chat API] Screenshot for LLM:", !!screenshot, screenshot ? `(${screenshot.length} chars)` : "none");
