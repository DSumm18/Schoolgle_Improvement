...
export class ProactiveService {
  ...
  constructor(
    ...
    this.config = {
      ...
      idleTimeout: 120000, // 2 minutes (was 30s — too aggressive)
      pageRules: {
        fees: "I know school fees can be confusing. Would you like to see our bursary options?",
        bursary:
          "We offer several financial support packages. Shall I guide you through the application?",
        transport:
          "Do you need help finding the nearest school bus stop to your home?",
        apply:
          "Starting an application is the first step! I can help you fill out this form if you like.",
        admissions:
          "Admissions are open for next year. Would you like to know about the deadlines?",
      },
      ...config,
    };
