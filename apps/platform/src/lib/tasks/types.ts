...
export type TaskType = 'general' | 'estates' | 'compliance' | 'governance' | 'siams' | 'ofsted';
...
export type TaskApprovalStatus = 'draft' | 'pending_approval' | 'approved' | 'rejected';
...
export type TeamType = 'department' | 'committee' | 'working_group' | 'project_team';
 ...
 */
export const DEFAULT_CHECKLIST_TEMPLATES: Record<string, Partial<ActionChecklistItem>[]> = {
    policy_review: [
        ...
        { id: '4', title: 'Share with stakeholders for feedback', completed: false },
