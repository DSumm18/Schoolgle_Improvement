...
export type OfstedSubCategoryId =
    // Inclusion
    | 'inclusion-send' | 'inclusion-disadvantaged' | 'inclusion-mental-health'
    // Curriculum and Teaching
    | 'curriculum-intent' | 'curriculum-implementation' | 'curriculum-reading'
    // Achievement
    | 'achievement-outcomes' | 'achievement-progress' | 'achievement-destinations'
    // Attendance and Behaviour
    | 'attendance-overall' | 'behaviour-conduct' | 'behaviour-attitudes'
    // Personal Development and Well-being
    | 'pd-character' | 'pd-citizenship' | 'pd-enrichment' | 'pd-rse'
    // Leadership and Governance
    | 'leadership-vision' | 'leadership-governance' | 'leadership-staff' | 'leadership-engagement';

export type OfstedRating = 'exceptional' | 'strong_standard' | 'expected_standard' | 'needs_attention' | 'urgent_improvement';
 ...
 */
export const OFSTED_JUDGEMENTS: Record<OfstedCategoryId, { name: string; shortName: string; color: string; order: number }> = {
    'inclusion': { name: 'Inclusion', shortName: 'Inclusion', color: 'teal', order: 1 },
    'curriculum-teaching': { name: 'Curriculum and Teaching', shortName: 'Education', color: 'rose', order: 2 },
    'achievement': { name: 'Achievement', shortName: 'Achievement', color: 'blue', order: 3 },
    'attendance-behaviour': { name: 'Attendance and Behaviour', shortName: 'Behaviour', color: 'orange', order: 4 },
    'personal-development': { name: 'Personal Development and Well-being', shortName: 'Personal Dev', color: 'violet', order: 5 },
    'leadership-governance': { name: 'Leadership and Governance', shortName: 'Leadership', color: 'slate', order: 6 },
} as const;

/**
 * All Ofsted subcategory IDs with their descriptions
 */
export const OFSTED_SUBCATEGORIES: Record<OfstedSubCategoryId, { category: OfstedCategoryId; name: string; description: string; order: number }> = {
    // Inclusion
    'inclusion-send': { category: 'inclusion', name: 'SEND Provision', description: 'Support for pupils with SEND', order: 1 },
    'inclusion-disadvantaged': { category: 'inclusion', name: 'Disadvantaged Pupils', description: 'Support for disadvantaged pupils', order: 2 },
    'inclusion-mental-health': { category: 'inclusion', name: 'Mental Health Support', description: 'Support for mental health', order: 3 },
    // Curriculum and Teaching
    'curriculum-intent': { category: 'curriculum-teaching', name: 'Curriculum Design', description: 'How well is the curriculum designed?', order: 1 },
    'curriculum-implementation': { category: 'curriculum-teaching', name: 'Teaching Quality', description: 'How effectively is the curriculum taught?', order: 2 },
    'curriculum-reading': { category: 'curriculum-teaching', name: 'Reading and Literacy', description: 'How well is reading taught?', order: 3 },
    // Achievement
    'achievement-outcomes': { category: 'achievement', name: 'Academic Outcomes', description: 'What do pupils achieve?', order: 1 },
    'achievement-progress': { category: 'achievement', name: 'Progress', description: 'How well do pupils progress?', order: 2 },
    'achievement-destinations': { category: 'achievement', name: 'Preparation for Next Stage', description: 'Preparation for next stage', order: 3 },
    // Attendance and Behaviour
    'attendance-overall': { category: 'attendance-behaviour', name: 'Attendance', description: 'How high is attendance?', order: 1 },
    'behaviour-conduct': { category: 'attendance-behaviour', name: 'Conduct', description: 'How is behaviour managed?', order: 2 },
    'behaviour-attitudes': { category: 'attendance-behaviour', name: 'Attitudes to Learning', description: 'Are pupils engaged?', order: 3 },
    // Personal Development
    'pd-character': { category: 'personal-development', name: 'Character Development', description: 'How is character developed?', order: 1 },
    'pd-citizenship': { category: 'personal-development', name: 'British Values', description: 'Are British values promoted?', order: 2 },
    'pd-enrichment': { category: 'personal-development', name: 'Enrichment', description: 'What wider opportunities exist?', order: 3 },
    'pd-rse': { category: 'personal-development', name: 'RSE', description: 'Is RSE delivered effectively?', order: 4 },
    // Leadership and Governance
    'leadership-vision': { category: 'leadership-governance', name: 'Vision and Strategy', description: 'Is there a clear vision?', order: 1 },
    'leadership-governance': { category: 'leadership-governance', name: 'Governance', description: 'How effective is governance?', order: 2 },
    'leadership-staff': { category: 'leadership-governance', name: 'Staff Development', description: 'How are staff developed?', order: 3 },
    'leadership-engagement': { category: 'leadership-governance', name: 'Stakeholder Engagement', description: 'Are parents engaged?', order: 4 },
} as const;
