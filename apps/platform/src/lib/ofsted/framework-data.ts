        ...
        subcategories: [
            {
                ...
                evidenceRequired: [
                    { id: 'out-1', name: 'KS2 Results', description: 'End of KS2 outcomes' },
                    { id: 'out-2', name: 'Phonics Results', description: 'Year 1 phonics outcomes' },
            ...
            },
            {
                ...
                inspectionFocus: [
                    'Are pupils ready for next stage?'
                ]
            }
        ]
    },
        ...
        subcategories: [
            {
                ...
                evidenceRequired: [
                    ...
                    { id: 'att-2', name: 'PA Data', description: 'Persistent absence rates' },
            ...
            },
            {
                ...
                evidenceRequired: [
                    ...
                    { id: 'beh-2', name: 'Exclusion Data', description: 'Exclusion rates and trends' }
                ],
                keyIndicators: [
        ...
        subcategories: [
            {
                ...
                evidenceRequired: [
                    ...
                    { id: 'vis-2', name: 'Development Plan', description: 'Strategic improvement priorities' }
                ],
                keyIndicators: [
            ...
            },
            {
                ...
                evidenceRequired: [
                    { id: 'gov-1', name: 'Governor Minutes', description: 'Evidence of challenge' },
...
export function getCategory(categoryId: OfstedCategoryId): Category | undefined {
    return OFSTED_FRAMEWORK_DATA.find(c => c.id === categoryId);
}

export function getSubcategory(subcategoryId: OfstedSubCategoryId): SubCategory | undefined {
