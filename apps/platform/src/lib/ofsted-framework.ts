...
export const SAFEGUARDING_STATUS = {
  met: {
    label: "Met",
    color: "bg-green-500",
    description: "Safeguarding requirements are met",
  },
  not_met: {
    label: "Not Met",
    color: "bg-red-500",
    description: "Safeguarding requirements are NOT met",
  },
  not_assessed: {
    label: "Not Assessed",
    color: "bg-gray-400",
...
export const OFSTED_FRAMEWORK: Category[] = [
  {
    ...
    color: "teal",
    guidanceSummary:
      "Inspectors evaluate how effectively the school identifies and supports pupils with additional needs, including those with SEND, disadvantaged pupils, and those with mental health needs. This includes the quality of the graduated approach and how well the curriculum is adapted.",
    guidanceLink:
    ...
    subcategories: [
      ...
      },
      {
        ...
        description:
          "Support and outcomes for disadvantaged pupils including those eligible for Pupil Premium",
        evidenceRequired: [
          {
            id: "pp-1",
      ...
      },
      {
        ...
        description:
          "Support for pupils with mental health needs and promotion of wellbeing",
        evidenceRequired: [
          {
            id: "mh-1",
          ...
          },
          {
            id: "mh-4",
            name: "Staff Training",
            description: "Mental health awareness training",
          },
        ],
        keyIndicators: [
  ...
  },
  {
    ...
    color: "rose",
    guidanceSummary:
      "Inspectors evaluate how well the curriculum is designed, sequenced and taught. This includes whether it is ambitious for all pupils, how well it builds knowledge over time, and the quality of pedagogy.",
    guidanceLink:
      "https://www.gov.uk/government/publications/education-inspection-framework",
    subcategories: [
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            ...
            description: "How curriculum builds cultural capital",
          },
        ],
        keyIndicators: [
      ...
      },
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            id: "teach-4",
            name: "CPD Records",
            description: "Staff development and impact",
          },
          {
            id: "teach-5",
            name: "Feedback Policy",
            description: "Approach to feedback",
          },
        ],
        keyIndicators: [
      ...
      },
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            id: "read-3",
            name: "Book Matching",
            description: "How books are matched to phonics stage",
          },
          {
            id: "read-4",
            name: "Intervention Data",
            description: "Keep-up/catch-up intervention impact",
          },
          {
            id: "read-5",
            name: "Phonics Results",
            description: "Phonics screening check outcomes",
          },
        ],
        keyIndicators: [
  ...
  },
  {
    ...
    color: "blue",
    guidanceSummary:
      "Inspectors evaluate the outcomes pupils achieve, including national test and examination results, and the progress pupils make from their starting points. This includes outcomes for different groups of pupils.",
    guidanceLink:
      "https://www.gov.uk/government/publications/education-inspection-framework",
    subcategories: [
      {
        ...
        evidenceRequired: [
          {
            id: "out-1",
            name: "KS2 Results",
            description: "End of KS2 outcomes and progress",
          },
          {
            id: "out-2",
            name: "Phonics Results",
            description: "Year 1 phonics screening outcomes",
          },
          {
            id: "out-3",
            name: "EYFS Outcomes",
          ...
          },
          {
            id: "out-4",
            name: "Progress Data",
            description: "In-year progress tracking",
          },
          {
            id: "out-5",
            name: "Group Analysis",
            description: "Outcomes by pupil group",
          },
        ],
        keyIndicators: [
      ...
      },
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            id: "prog-3",
            name: "Value Added",
            description: "Progress scores where available",
          },
          {
            id: "prog-4",
            name: "Cohort Analysis",
            description: "Tracking cohorts over time",
          },
        ],
        keyIndicators: [
  ...
  },
  {
    ...
    color: "orange",
    guidanceSummary:
      "Inspectors evaluate attendance levels including persistent absence, the effectiveness of strategies to improve attendance, behaviour in lessons and around school, and pupils attitudes to learning.",
    guidanceLink:
      "https://www.gov.uk/government/publications/education-inspection-framework",
    subcategories: [
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            id: "att-2",
            name: "PA Data",
            description: "Persistent absence rates and trends",
          },
          {
            id: "att-3",
          ...
          },
          {
            ...
            description: "Impact of attendance strategies",
          },
          {
            id: "att-5",
            name: "Group Breakdown",
            description: "Attendance by pupil group",
          },
        ],
        keyIndicators: [
      ...
      },
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            id: "beh-2",
            name: "Exclusion Data",
            description: "Fixed term and permanent exclusions",
          },
          {
            id: "beh-3",
            name: "Behaviour Logs",
            description: "Incident recording and trends",
          },
          {
            id: "beh-4",
            name: "Restorative Approaches",
            description: "How relationships are repaired",
          },
        ],
        keyIndicators: [
      ...
      },
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            id: "atl-3",
            name: "Work Scrutiny",
            description: "Evidence of effort and pride",
          },
        ],
        keyIndicators: [
  ...
  },
  {
    ...
    color: "violet",
    guidanceSummary:
      "Inspectors evaluate how well the school develops pupils character, resilience, confidence and independence. This includes PSHE, RSE, British Values, and enrichment opportunities.",
    guidanceLink:
      "https://www.gov.uk/government/publications/education-inspection-framework",
    subcategories: [
      {
        ...
        evidenceRequired: [
          ...
          {
            id: "char-3",
            name: "Pupil Leadership",
            description: "Opportunities for leadership",
          },
        ],
        keyIndicators: [
      ...
      },
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            id: "bv-3",
            name: "Rule of Law",
            description: "Understanding of rules and laws",
          },
          {
            id: "bv-4",
            name: "Tolerance",
            description: "Respect for diversity",
          },
        ],
        keyIndicators: [
      ...
      },
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            ...
            description: "Evidence of consultation",
          },
        ],
        keyIndicators: [
  ...
  },
  {
    ...
    color: "gray",
    guidanceSummary:
      "Inspectors evaluate how effectively leaders and governors ensure the school provides a high quality education, how they develop staff, manage workload and wellbeing, and engage with parents and the community.",
    guidanceLink:
      "https://www.gov.uk/government/publications/education-inspection-framework",
    subcategories: [
      {
        ...
        evidenceRequired: [
          ...
          },
          {
            ...
            description: "Accurate self-knowledge",
          },
        ],
        keyIndicators: [
        ...
        evidenceRequired: [
          {
            ...
            description: "Evidence of support and challenge",
          },
          {
            id: "gov-2",
          ...
          },
          {
            ...
            description: "Governor monitoring activity",
          },
        ],
        keyIndicators: [
        ...
        evidenceRequired: [
          {
            id: "parent-1",
            name: "Parent Survey",
            description: "Parent views and feedback",
          },
          {
            id: "parent-2",
            name: "Communication",
            description: "How parents are kept informed",
          },
          {
            id: "parent-3",
            name: "Complaints",
            description: "Complaints handling",
          },
        ],
        keyIndicators: [
...
export const SAFEGUARDING_FRAMEWORK = {
  ...
  color: "red",
  guidanceSummary:
    'Safeguarding is now assessed separately from the main evaluation areas. It is judged as either "Met" or "Not Met". A "Not Met" judgment is serious and will trigger immediate action.',
  requirements: [
    {
      id: "sg-1",
      name: "Safeguarding Policy",
      description: "Current policy reflecting KCSIE",
    },
    {
      id: "sg-2",
      name: "Single Central Record",
      description: "Compliant and up to date SCR",
    },
    {
      id: "sg-3",
      name: "DSL Arrangements",
      description: "Trained DSL and deputies",
    },
    {
      id: "sg-4",
      name: "Staff Training",
      description: "All staff trained on safeguarding",
    },
    {
      id: "sg-5",
      name: "Referral Procedures",
      description: "Clear and followed procedures",
    },
    {
      id: "sg-6",
      name: "Safer Recruitment",
      description: "Robust recruitment practices",
    },
    {
      id: "sg-7",
      name: "CPOMS/Recording",
      description: "Effective concern recording",
    },
    {
      id: "sg-8",
      name: "Prevent Duty",
      description: "Prevent duty implemented",
    },
    {
      id: "sg-9",
      name: "Online Safety",
      description: "Effective online safety measures",
    },
    {
      id: "sg-10",
      name: "Site Security",
      description: "Appropriate site security",
    },
  ],
  keyIndicators: [
...
export function calculateCategoryReadiness(
  categoryId: string,
  assessments: Record<string, OfstedAssessment>,
  ...
  for (const sub of category.subcategories) {
    ...
    if (
      ...
      assessment.schoolRating !== "not_assessed"
    ) {
      assessedCount++;
      const rating =
        OFSTED_RATINGS[assessment.schoolRating as keyof typeof OFSTED_RATINGS];
      totalUserScore += (rating?.score || 0) * 20; // Convert to percentage
    }
  }

  const userScore =
    assessedCount > 0 ? Math.round(totalUserScore / assessedCount) : 0;
...
export function calculateOverallReadiness(
  ...
  return {
    userScore:
      categoryCount > 0 ? Math.round(totalUserScore / categoryCount) : 0,
