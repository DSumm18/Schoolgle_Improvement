...
export type CheckFrequency = 'hourly' | 'daily' | 'weekly' | 'monthly' | 'quarterly' | 'annually' | 'termly' | 'ad_hoc';
export type CheckStatus = 'pending' | 'in_progress' | 'completed' | 'overdue' | 'skipped' | 'not_applicable';
...
export const STATUTORY_CHECKS: Record<ComplianceDomain, StatutoryCheck[]> = {
  ...
  legionella: [
    {
      ...
      description: 'Check and record cold water (below 20°C) and hot water (stored at 60°C+, distributed at 50°C+) temperatures at sentinel outlets',
      category: 'statutory',
      frequency: 'monthly',
      reference: 'HSE L8 paras 157-158',
      referenceUrl: 'https://www.hse.gov.uk/pubns/books/l8.htm',
      estimatedDuration: 30,
      evidenceRequired: ['Temperature readings log', 'Thermometer calibration certificate'],
      notes: 'Check representative outlets including calorifier, cold water tank, and distant outlets',
    },
    {
      id: 'leg_weekly_flush',
      domain: 'legionella',
      name: 'Weekly Outlet Flushing',
      description: 'Flush all outlets used infrequently (at least weekly if not used for 7+ days)',
      category: 'statutory',
      frequency: 'weekly',
    ...
    },
    {
      ...
      description: 'Review and update legionella risk assessment, considering any changes to the water system',
      category: 'statutory',
      frequency: 'annually',
      reference: 'HSE L8',
      referenceUrl: 'https://www.hse.gov.uk/pubns/books/l8.htm',
    ...
    },
    {
      ...
      description: 'Comprehensive review of water system, monitoring regime, and control measures',
      category: 'statutory',
    ...
    },
    {
      ...
      description: 'Check calorifier performance, stratification, and cleanliness',
      category: 'statutory',
      frequency: 'monthly',
    ...
    },
    {
      ...
      description: 'Inspect cold water storage tank for condition, lid integrity, lagging, and contamination',
      category: 'statutory',
      frequency: 'annually',
      reference: 'HSE HSG274',
      referenceUrl: 'https://www.hse.gov.uk/pubns/priced/hsg274part2.pdf',
    ...
    // Good practice checks
    {
      ...
      description: 'Install and monitor sentinel outlets to assess water system condition',
      ...
      notes: 'HSE HSG274 describes as good practice example, not statutory requirement',
    },
  ],
  ...
  fire: [
    {
      ...
      description: 'Test a different call point each week and record the result',
      category: 'statutory',
      frequency: 'weekly',
      reference: 'RRO 2005, BS5839',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/2005/1541/contents/made',
      estimatedDuration: 15,
    ...
    },
    {
      ...
      description: 'Check all extinguishers are in correct location, unobstructed, not damaged, pressure gauge in green',
      category: 'statutory',
      frequency: 'monthly',
    ...
    },
    {
      ...
      description: 'Professional service and certification of all fire extinguishers',
      category: 'statutory',
      frequency: 'annually',
      reference: 'BS5306',
    ...
    },
    {
      ...
      description: 'Review and update fire risk assessment, considering changes to building or usage',
      category: 'statutory',
      frequency: 'annually',
    ...
    },
    {
      ...
      description: 'Check all escape routes are clear, exit signs illuminated, doors open freely',
      category: 'statutory',
      frequency: 'weekly',
      reference: 'RRO 2005',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/2005/1541/contents/made',
    ...
    },
    {
      ...
      description: 'Monthly inspection of fire blankets, hose reels, and other equipment',
      category: 'statutory',
      frequency: 'monthly',
      reference: 'RRO 2005',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/2005/1541/contents/made',
    ...
    },
    {
      ...
      description: 'Check fire doors close properly, intumescent seals intact, gaps correct size',
      category: 'statutory',
      frequency: 'monthly',
      reference: 'RRO 2005',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/2005/1541/contents/made',
    ...
    },
    {
      ...
      description: 'Professional service and testing of fire alarm control panel',
      category: 'statutory',
      frequency: 'quarterly',
      reference: 'BS5839',
      referenceUrl: 'https://www.bsi.group.com/en/standards/british-standards',
  ...
  asbestos: [
    {
      ...
      description: 'Review asbestos register for accuracy, update if any ACMs have been disturbed or removed',
      category: 'statutory',
      frequency: 'annually',
      reference: 'CAR 2012',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/2012/2307/contents/made',
      estimatedDuration: 60,
    ...
    },
    {
      ...
      description: 'Full re-survey of asbestos-containing materials by UKAS accredited surveyor',
      category: 'statutory',
    ...
    },
    {
      ...
      description: 'Visual inspection of all known asbestos-containing materials for damage or deterioration',
      category: 'statutory',
      frequency: 'annually',
      reference: 'CAR 2012',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/2012/2307/contents/made',
    ...
    },
    {
      ...
      description: 'Review and update asbestos management plan, ensuring all duties are covered',
      category: 'statutory',
      frequency: 'annually',
    ...
    },
    {
      ...
      description: 'Ensure all relevant staff have asbestos awareness training (refresh annually)',
      category: 'statutory',
      frequency: 'annually',
      reference: 'CAR 2012',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/2012/2307/contents/made',
  ...
  electrical: [
    {
      ...
      description: 'Periodic inspection and testing of electrical installations (5 yearly for schools)',
      category: 'statutory',
      frequency: 'annually', // Tracked annually, done every 5 years
      reference: 'EAWR 1989, BS7671',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/1989/635/contents/made',
    ...
    },
    {
      ...
      description: 'Testing of portable electrical equipment (Class 1 equipment annually, Class 2 every 2-4 years)',
      category: 'statutory',
      frequency: 'annually',
      reference: 'EAWR 1989',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/1989/635/contents/made',
    ...
    },
    {
      ...
      description: 'Quarterly visual inspection of DBs for signs of overheating, damage, or moisture',
      category: 'statutory',
      frequency: 'quarterly',
      reference: 'EAWR 1989',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/1989/635/contents/made',
    ...
    },
    {
      ...
      description: 'Quarterly check of socket outlets for damage, cracks, or overheating signs',
      category: 'good_practice',
      frequency: 'quarterly',
      reference: 'EAWR 1989',
      referenceUrl: 'https://www.legislation.gov.uk/ukdsi/1989/635/contents/made',
  ...
  gas: [
    {
      ...
      description: 'Gas safety inspection of all gas appliances and flues by Gas Safe registered engineer',
      category: 'statutory',
      frequency: 'annually',
      reference: 'GFPA 1995',
    ...
    },
    {
      ...
      description: 'Additional gas safety requirements for educational establishments',
      category: 'statutory',
      frequency: 'annually',
    ...
    },
    {
      ...
      description: 'Visual check for gas leaks, proper ventilation, and safe operation',
      category: 'statutory',
      frequency: 'monthly',
      reference: 'GFPA 1995',
      referenceUrl: 'https://www.legislation.gov.uk/ukpga/1995/23/contents',
    ...
    },
    {
      ...
      description: 'Monthly check that gas emergency shut-off controls are accessible and labelled',
      category: 'statutory',
      frequency: 'monthly',
      reference: 'GFPA 1995',
      referenceUrl: 'https://www.legislation.gov.uk/ukpga/1995/23/contents',
  ...
  water: [
    {
      ...
      description: 'Annual testing of drinking water quality for bacteria and chemical parameters',
      category: 'statutory',
      frequency: 'annually',
      reference: 'Water Supply (Water Quality) Regulations 2016',
      referenceUrl: 'https://www.legislation.gov.uk/uksi/2016/614/contents/made',
      estimatedDuration: 60,
    ...
    },
    {
      ...
      description: 'Annual inspection of cold water storage tanks for condition, cleanliness, and contamination',
      category: 'statutory',
      frequency: 'annually',
  ...
  mechanical: [
    {
      ...
      referenceUrl: 'https://www.legislation.gov.uk/uksi/1998/2451/contents/made',
      estimatedDuration: 120,
  ...
  lifts: [
    {
      ...
      description: 'Thorough examination of lift by competent person (every 6 months for passenger lifts)',
      category: 'statutory',
      frequency: 'annually', // Tracked annually, done every 6 months
      reference: 'LOLER 1998',
      referenceUrl: 'https://www.legislation.gov.uk/ukpga/1998/23/contents/made',
      estimatedDuration: 120,
      requiresQualification: 'Competent person (insurance company or specialist)',
    ...
    },
    {
      ...
      description: 'Daily visual and functional check of lift operations and emergency telephone',
      category: 'statutory',
      frequency: 'daily',
      reference: 'LOLER 1998',
      referenceUrl: 'https://www.legislation.gov.uk/ukpga/1998/23/contents/made',
    ...
    },
    {
      ...
      referenceUrl: 'https://www.legislation.gov.uk/ukpga/1998/37/contents/made',
      estimatedDuration: 60,
  ...
  playground: [
    {
      ...
      description: 'Annual professional inspection of all playground equipment by RPII qualified inspector',
      category: 'statutory',
      frequency: 'annually',
    ...
    },
    {
      ...
      description: 'Weekly visual check for damage, litter, vandalism, and general safety',
      category: 'statutory',
      frequency: 'weekly',
      reference: 'PUWER 1998',
      referenceUrl: 'https://www.legislation.gov.uk/ukpga/1998/37/contents/made',
    ...
    },
    {
      ...
      description: 'Quarterly inspection of safety surfacing for wear, damage, and impact absorption',
      category: 'statutory',
      frequency: 'quarterly',
      reference: 'EN 1177',
      referenceUrl: 'https://www.bsi.group.com/en/standards/british-standards',
  ...
  accessibility: [
    ...
    },
    {
      ...
      description: 'Monthly check that accessible routes, toilets, and facilities are functional',
      category: 'statutory',
      frequency: 'monthly',
      reference: 'Equality Act 2010',
      referenceUrl: 'https://www.legislation.gov.uk/ukpga/2010/15/contents',
  ...
  security: [
    {
      ...
      description: 'Weekly check of fences, gates, locks, and perimeter security',
      category: 'good_practice',
      frequency: 'weekly',
    ...
    },
    {
      ...
      description: 'Weekly check that CCTV cameras are recording and storage is functional',
      category: 'good_practice',
      frequency: 'weekly',
      estimatedDuration: 15,
  ...
  manual_handling: [
    {
      ...
      description: 'Review manual handling risk assessments for all relevant tasks',
      category: 'statutory',
      frequency: 'annually',
      reference: 'Manual Handling Operations Regulations 1992',
      referenceUrl: 'https://www.legislation.gov.uk/ukpga/1992/27/contents/made',
      estimatedDuration: 60,
  ...
  working_at_height: [
    {
      ...
      description: 'Annual inspection of ladders, steps, towers, and access equipment',
      category: 'statutory',
      frequency: 'annually',
      reference: 'Work at Height Regulations 2005',
      referenceUrl: 'https://www.legislation.gov.uk/ukksi/2005/735/contents/made',
      estimatedDuration: 60,
      requiresQualification: 'Competent person',
 ...
 */
export const DOMAIN_METADATA: Record<ComplianceDomain, {
  name: string;
  description: string;
  icon: string;
  color: string;
 ...
 */
export function getChecksByFrequency(frequency: CheckFrequency): StatutoryCheck[] {
  return getAllStatutoryChecks().filter(check => check.frequency === frequency);
}
