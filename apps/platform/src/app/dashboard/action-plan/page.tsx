        ...
        <div className="p-8 space-y-8 max-w-[1600px] mx-auto min-h-screen">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-4">
                ...
                <div className="flex gap-4">
                    <button className="flex items-center gap-2.5 px-6 py-3.5 bg-white dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 rounded-[1.25rem] text-sm font-black text-slate-700 dark:text-slate-200 hover:bg-slate-50 transition-all shadow-sm hover:shadow-xl active:scale-95 group">
