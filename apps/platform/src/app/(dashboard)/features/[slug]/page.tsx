      ...
      <div className="pt-32 px-6 min-h-screen flex flex-col items-center justify-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-lp-text-sec max-w-2xl mx-auto font-medium leading-relaxed">
            The ultimate operations engine for this feature is currently
            launching. <br />
            <span className="text-lp-text">
              The future of readiness is almost here.
            </span>
          </p>
          ...
          <div className="pt-8">
            <Link
              href="/#early-access"
              className="px-10 py-5 bg-lp-accent text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-blue-600 transition-all shadow-md"
            >
              Get Notified
            </Link>
          </div>
