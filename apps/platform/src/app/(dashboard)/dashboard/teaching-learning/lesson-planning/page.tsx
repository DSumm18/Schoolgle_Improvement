    ...
    return (
        <div className="p-8 space-y-10 animated-mesh min-h-screen max-w-[1600px] mx-auto">
            ...
            >
                ...
                <h1 className="text-5xl font-black text-slate-900 dark:text-white tracking-tight mb-4 relative z-10">Lesson Planning</h1>
                <div className="px-6 py-2 bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest rounded-full mb-8 relative z-10 shadow-lg">
                    Coming Soon
                </div>
                
                <p className="text-xl text-slate-500 dark:text-slate-400 font-medium max-w-xl leading-relaxed relative z-10">
                    We're building an intelligent lesson planning engine that aligns with your school's curriculum and Ofsted requirements automatically.
                </p>
