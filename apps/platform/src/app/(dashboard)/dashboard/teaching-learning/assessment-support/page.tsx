        ...
        <div className="p-8 space-y-10 animated-mesh min-h-screen max-w-[1600px] mx-auto">
            ...
            >
                ...
                <div className="p-8 bg-white dark:bg-slate-800 rounded-full shadow-2xl mb-8 relative z-10">
                    <CheckSquare size={64} className="text-emerald-600" />
                </div>

                <h1 className="text-5xl font-black text-slate-900 dark:text-white tracking-tight mb-4 relative z-10">Assessment Support</h1>
                <div className="px-6 py-2 bg-emerald-600 text-white text-[10px] font-black uppercase tracking-widest rounded-full mb-8 relative z-10 shadow-lg">
                    Coming Soon
                </div>

                <p className="text-xl text-slate-500 dark:text-slate-400 font-medium max-w-xl leading-relaxed relative z-10">
                    Streamline your marking and assessment. Get AI-driven insights into pupil progress and automated feedback suggestions.
                </p>
