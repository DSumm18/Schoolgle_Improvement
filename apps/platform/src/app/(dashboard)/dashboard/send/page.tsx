  ...
  return (
    <div className="p-8 space-y-10 animated-mesh min-h-screen max-w-[1600px] mx-auto">
      <motion.div
        ...
        className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-700/50 rounded-2xl p-12 relative overflow-hidden shadow-sm"
      >
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-xl text-slate-500 dark:text-slate-400 font-medium max-w-2xl leading-relaxed">
            Comprehensive provision mapping and EHCP tracking to ensure every
            student receives the support they need.
          </p>
        </div>

        <div className="mt-16 p-12 rounded-2xl bg-emerald-50/50 dark:bg-emerald-900/10 border-2 border-dashed border-emerald-200 dark:border-emerald-800 text-center">
          <h3 className="text-2xl font-black text-emerald-900 dark:text-emerald-100 mb-2">
            SEND Module Coming Soon
          </h3>
          <p className="text-emerald-700 dark:text-emerald-300 font-medium">
            Developing advanced tools for SENCOs to manage interventions,
            reviews, and external agency collaboration.
          </p>
        </div>
      </motion.div>
    </div>
