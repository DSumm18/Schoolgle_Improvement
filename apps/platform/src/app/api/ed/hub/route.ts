...
async function getHelpTopics() {
  return {
    topics: [
      ...
      { id: "hr", title: "HR & Staff Management", icon: "👥" },
      { id: "finance", title: "Finance & Budget", icon: "💰" },
      { id: "compliance", title: "Compliance & Policies", icon: "📋" },
...
/**
 * Submit a question for follow-up
 */
