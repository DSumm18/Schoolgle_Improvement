...
export default async function InsightPage({ params }: Props) {
  ...
  return (
    <article className="sg-wrap py-12 md:py-20" style={{ maxWidth: 820 }}>
      ...
      <p className="sg-eyebrow">The Schoolgle notebook</p>
      ...
      <div className="sg-article" dangerouslySetInnerHTML={{ __html: html }} />
      <aside className="border-t border-border mt-12 pt-6 text-sm text-muted-foreground leading-relaxed">
        <p className="font-semibold text-foreground mb-2">Source and scope</p>
        <a
        ...
        <p className="mt-3">
          ...
          suggested routines are Schoolgle&apos;s editorial interpretation. DfE
          and Ofsted guidance discussed here applies to England; other UK
      ...
      <div className="mt-12 p-7 bg-card border border-border rounded-xl">
        ...
        <p className="text-muted-foreground my-4">
          Bring us the task your team wants to make easier. We will walk through
          where Schoolgle can help.
        </p>
