...
export default function EdParentsPage() {
    return (
        <main className="pt-32 pb-40 px-6 bg-background transition-colors duration-700">
            <div className="max-w-7xl mx-auto">
                <div className="text-center space-y-8 mb-24">
                    ...
                    >
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">Parental Engagement</span>
                    </motion.div>

                    <h1 className="text-6xl md:text-8xl font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-[0.9]">
                        Ed for Parents. <br />
                        <span className="text-slate-400 dark:text-slate-600">Simpler communication.</span>
                    </h1>

                    <p className="text-xl text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
                        Fewer calls, clearer messages, and safer message routing. Ed answers parent queries 24/7, leaving your office staff to focus on the children.
                    </p>
