...
const CATEGORY_COLOR_CONFIG: Record<
  string,
...
export const FrameworkCategoryCard: React.FC<FrameworkCategoryCardProps> = ({
  ...
  const config =
    CATEGORY_COLOR_CONFIG[category.color] || CATEGORY_COLOR_CONFIG.gray;
  ...
  return (
    ...
    >
      <div
        ...
        className="w-full text-left p-6 flex items-center justify-between group hover:bg-slate-50/10 transition-colors cursor-pointer"
      >
        <div className="flex items-center gap-5 flex-1 min-w-0">
          <div
            className={`p-3 rounded-xl ${config.bg} ${config.text} group-hover:scale-110 transition-transform duration-300`}
          >
