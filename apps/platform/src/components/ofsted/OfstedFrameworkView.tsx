...
export default function OfstedFrameworkView({
  ...
  const auth = useAuth();
  const { organization, signInWithMicrosoft } = auth;
  ...
  const handleStartScan = async () => {
    ...
    setScanProgress({
      status: "scanning",
      message: "Initiating AI Evidence Scan...",
      stats: undefined,
    });
    ...
    const provider =
      providerId === "microsoft.com" ? "microsoft.com" : "google.com";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10 animated-mesh min-h-screen">
        ...
        {evidenceModal.isOpen && (
          <EvidenceModal
            ...
            onClose={() =>
              setEvidenceModal({ ...evidenceModal, isOpen: false })
            }
          />
        )}
        ...
        {showEdPanel && (
          <EdAnalysisPanel
            selectedCategory={edContext.category}
