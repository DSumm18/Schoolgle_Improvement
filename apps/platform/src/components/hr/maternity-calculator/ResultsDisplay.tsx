    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <Badge
              variant={
                eligibility.statutoryPayEligible ? "outline" : "destructive"
              }
            >
              {eligibility.statutoryPayEligible
                ? `Eligible (${eligibility.statutoryPayWeeks} weeks)`
                : "Not Eligible"}
            </Badge>
          </div>
          {!eligibility.statutoryPayEligible &&
            eligibility.statutoryPayReason && (
              <p className="text-sm text-red-600">
                Note: {eligibility.statutoryPayReason}
              </p>
            )}
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Amounts shown before tax and deductions.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            ...
            <TableBody>
              ...
              {paySchedule.length > 20 && (
                <TableRow>
                  ...
                  >
                    ... and {paySchedule.length - 20} more weeks
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
      ...
      <div className="space-y-4">
        {notes.map((note, i) => (
          <Alert
            key={i}
            variant={note.type === "warning" ? "destructive" : "default"}
          >
            {note.type === "warning" ? (
            ...
            <AlertTitle>
              {note.type === "warning" ? "Important" : "Note"}
            </AlertTitle>
