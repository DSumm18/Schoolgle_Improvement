...
import {
  STATUTORY_CHECKS,
  ComplianceDomain as StatutoryDomain,
...
const DOMAIN_FINDINGS: Record<string, SuggestedFinding[]> = {
  legionella: [
    {
      ...
      description:
        "Cold water outlet measured above the recommended 20°C limit",
      action_required:
        "Investigate cause of high temperature, check calorifier performance and pipe insulation",
      severity: "high",
    ...
    },
    {
      ...
      description:
        "Hot water outlet measured below the recommended 50°C distribution temperature",
      action_required:
        "Check calorifier thermostat and settings, inspect for pipework heat loss",
      severity: "high",
      classification: "statutory",
    ...
    },
    {
      ...
      description:
        "Shower head and hose show signs of scale buildup or contamination",
      action_required:
        "Clean and descale shower head and hose, record in maintenance log",
      severity: "medium",
    ...
    },
    {
      ...
      action_required:
        "Flush outlet for minimum 2 minutes, record in flushing log",
      severity: "low",
      classification: "statutory",
    ...
    },
    {
      ...
      description:
        "Temperature difference noted within calorifier indicating potential stratification",
      action_required:
        "Check circulation pump operation, consider destratification measures",
      severity: "medium",
      classification: "good_practice",
  ...
  fire: [
    {
      ...
      action_required:
        "Contact fire alarm engineer within 24 hours, record in logbook",
      severity: "critical",
      classification: "statutory",
    ...
    },
    {
      ...
      action_required:
        "Clear obstruction immediately, ensure routes kept clear at all times",
      severity: "critical",
      classification: "statutory",
      source: "RRO 2005",
      source_url:
    ...
    },
    {
      ...
      action_required:
        "Replace faulty unit, arrange repair by qualified electrician",
      severity: "high",
      classification: "statutory",
    ...
    },
    {
      ...
      action_required:
        "Arrange repair by competent person, check intumescent seals",
      severity: "high",
      classification: "statutory",
      source: "RRO 2005",
      source_url:
  ...
  electrical: [
    {
      ...
      action_required:
        "Investigate by qualified electrician, do not use affected circuit",
      severity: "critical",
      classification: "statutory",
      source: "BS7671",
    ...
    },
    {
      ...
      description:
        "Distribution board or equipment showing signs of damage/burn marks",
      action_required:
        "Isolate circuit if safe, arrange immediate inspection by qualified electrician",
      severity: "critical",
      classification: "statutory",
      source: "EAWR 1989",
    ...
    },
    {
      ...
      action_required:
        "Remove from service, label as failed, arrange repair or replacement",
      severity: "medium",
      classification: "statutory",
      source: "EAWR 1989",
      source_url: "https://www.legislation.gov.uk/ukdsi/1989/635/contents/made",
  ...
  gas: [
    {
      ...
      action_required:
        "EVACUATE IMMEDIATELY, call Gas Emergency Service on 0800 111 999",
      severity: "critical",
      classification: "statutory",
      source: "GFPA 1995",
    ...
    },
    {
      ...
      action_required:
        "Clear obstruction immediately, ensure adequate ventilation maintained",
      severity: "high",
      classification: "statutory",
      source: "GFPA 1995",
      source_url: "https://www.legislation.gov.uk/ukpga/1995/23/contents",
    ...
    },
    {
      ...
      description:
        "Burner flame showing incorrect colour indicating combustion issue",
      action_required:
        "Do not use appliance, contact Gas Safe engineer for inspection",
      severity: "high",
      classification: "statutory",
      source: "GFPA 1995",
      source_url: "https://www.legislation.gov.uk/ukpga/1995/23/contents",
  ...
  asbestos: [
    {
      ...
      description:
        "Material suspected of containing asbestos appears damaged or disturbed",
      action_required:
        "DO NOT DISTURB, cordon off area, contact asbestos surveyor immediately",
      severity: "critical",
      classification: "statutory",
      source: "CAR 2012",
      source_url:
  ...
  water: [
    ...
    },
    {
      ...
      description:
        "Cold water storage tank shows signs of sediment or contamination",
  ...
  mechanical: [
    {
      ...
      action_required:
        "Check for leaks, repressurize if low, contact engineer if high",
      severity: "medium",
      classification: "good_practice",
  ...
  lifts: [
    {
      ...
      action_required:
        "Report to lift company immediately, display alternative contact number",
      severity: "high",
      classification: "statutory",
      source: "LOLER 1998",
  ...
  accessibility: [
    ...
    },
    {
      ...
      action_required:
        "Arrange repair, provide alternative access arrangements",
      severity: "medium",
      classification: "statutory",
      source: "Equality Act 2010",
      source_url: "https://www.legislation.gov.uk/ukpga/2010/15/contents",
...
export function FindingsAutoSuggest({
  ...
  const filteredFindings = useMemo(() => {
    ...
    findings = findings.filter(
      (finding) => !existingTitles.has(finding.description),
    );
    ...
    <div className="space-y-4">
            ...
            <CardContent className="p-4">
              ...
              {searchQuery.length > 0 && filteredFindings.length === 0 ? (
                <Alert>
                  ...
                  <AlertDescription>
                    No matching findings found. Try different keywords or enter
                    your finding manually.
                  </AlertDescription>
                </Alert>
              ) : (
      ...
      {searchQuery.length === 0 && showSuggestions && (
        <Alert>
          ...
          <AlertDescription>
            Start typing to see suggested findings based on statutory
            requirements and common issues for <strong>{domain}</strong>{" "}
            compliance.
          </AlertDescription>
        </Alert>
      )}
