...
import { X, User, Mail, Phone, Calendar, Building2, Briefcase, Shield } from 'lucide-react';
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <DialogFooter>
                        ...
                        <Button type="submit" disabled={saving} className="bg-blue-600 hover:bg-blue-700">
                            {saving ? 'Saving...' : isEditing ? 'Save Changes' : 'Add Governor'}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
