...
import { SiamsStrandId, SiamsEvidenceMatch, STRAND_QUESTIONS } from '@/lib/siams';
...
export default function SiamsEvidenceMatcher({
    ...
    const getAllQuestions = () => {
        ...
        return STRAND_QUESTIONS[selectedStrand]?.map((q) => ({ ...q, strand_id: selectedStrand })) || [];
    };
            ...
            <Card>
                <CardContent className="p-4">
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                        ...
                        <Button className="bg-purple-600 hover:bg-purple-700" onClick={() => setLinkDialogOpen(true)}>
