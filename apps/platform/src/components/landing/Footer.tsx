      ...
      <div className="container max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
        <div className="space-y-6 max-w-sm">
          ...
          <div className="text-[10px] font-black uppercase tracking-widest text-lp-text-muted">
            {schoolgleCompanyDetails.legalName}. ALL RIGHTS RESERVED.
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-16">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link href="/data-protection" className="text-sm font-medium text-lp-text-sec hover:text-lp-text transition-colors">Data Protection</Link>
            </div>
          </div>
        </div>
      </div>
      <div className="container max-w-7xl mx-auto mt-10 pt-6 border-t border-lp-border text-[10px] uppercase tracking-widest text-lp-text-muted">
        Registered in {schoolgleCompanyDetails.registeredJurisdiction}. Company No. {schoolgleCompanyDetails.companyNumber}. Registered office: {schoolgleCompanyDetails.registeredOffice}. ICO Registration {schoolgleCompanyDetails.icoRegistration}.
      </div>
    </footer>
  );
};
