      ...
      <div className="flex items-start gap-4 mb-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            <span
              className={`inline-flex px-2 py-0.5 text-xs font-medium rounded-full ${categoryStyle.bg} ${categoryStyle.text}`}
            >
              {tool.category}
            </span>
            <span
              className={`inline-flex px-2 py-0.5 text-xs font-medium rounded-full ${pricingStyle}`}
            >
              {tool.pricing}
            </span>
          </div>
